...
para1.innerHTML = "This node was created using the createElement() method";
p.appendChild(para1);

let myNode = document.createTextNode("This node was created using the createTextNode() method");
